<x-app-layout>
    <x-slot name="header">
        ...
        {{-- @if(session('message'))
            {{session('message')}}
        @endif --}}
        {{-- <x-message :message="session(session("message"))" /> --}}
        ...
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('post.store')}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="body" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="body" cols="30" rows="10">{{old('title')}}</textarea>
                </div>
                ...
                <x-primary-button class="myclassv mt-4">
                    送信する
                </x-primary-button>
