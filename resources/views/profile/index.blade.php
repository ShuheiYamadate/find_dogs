        ...
        <div class="my-6">
            <table class="text-left w-full border-collapse mt-8"> 
                ...
                <tr class="bg-white">
                    ...
                    <td class="border-gray-light border hover:bg-gray-100 p-3">
                        <a href="{{route('profile.edit', $user)}}"><x-primary-button class="myclass">編集</x-primary-button></a>
                    </td>
                    <td class="border-gray-light border hover:bg-gray-100 p-3">
                        <form method="post" action="{{route('profile.delete', $user)}}">
                            @csrf
                            @method('delete')
                            <x-primary-button class="myclassr" onClick="return confirm('本当に削除しますか？');">削除</x-primary-button>
                        </form>
                    </td>
                </tr>
                @endforeach
